    ...
    <>
      ...
      <div className="flex justify-between px-5 items-center mt-5">
        ...
        <div className="flex gap-3 border border-gray-300 rounded-md px-5 py-3" >
          <Dropdown label="Filter" options={priorities} value={filter} onChange={handleFilterChange} />
      <Dropdown label="Sort" options={sortOptions} value={sort} onChange={handleSortChange} />
        </div>
      </div>
      <AllTodos />
    </>
